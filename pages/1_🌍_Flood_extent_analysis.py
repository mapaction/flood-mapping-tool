        ...
        with col2:
            ...
            # Output error if no polygons were drawn
                ...
                with st.spinner("Computing... Please wait..."):
                    ...
                    detected_flood_vector, detected_flood_raster, _, _ = \
                    ...
                    try:
                        ...
                        if 'If one image has no bands, the other must also \
                            have no bands' in str(e):
                            st.error(
                    ...
                    with st.spinner("Computing... Please wait..."):
                        try:
                            ...
                            st.error(
                                ...
                                "interest (side <~ 150km) and repeat the "
                                "analysis."
                            )
                        else:
