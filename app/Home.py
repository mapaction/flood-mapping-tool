...
st.markdown(
    ...
    "imagery (before the flooding event) is defined. You can select even "
    "years "
    ...
    "Documentation). "
    "It is recommended to leave the parameter unchanged for a first "
    "estimation and change its value in case partial or no imagery is "
    "produced."
    "</p>"
    "</ul>"
    "<li><p>"
